...
export default function Rules() {
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-gray-900 text-gray-300" style={{ backgroundColor: '#212121' }}> {/* Adjusted className */}
      <Header />
      <div className="px-12 py-7 mx-12 my-7 text-lg tracking-wider leading-10 bg-gray-900 text-gray-300" style={{ backgroundColor: '#212121' }} > {/* Modified background and text color */}
        <ul className="pl-5">
